...
namespace Kogane
{
	...
	public sealed class MultiTaskWithTimeLog : ISequenceTask
	{
		...
		// デリゲート(static)
		//==============================================================================
		public static OnStartParentCallback  OnStartParent	{ get; set; } = parentName => Debug.Log( $"[MultiTask]「{parentName}」開始" );
		public static OnFinishParentCallback OnFinishParent	{ get; set; } = ( parentName, elapsedTime ) => Debug.Log( $"[MultiTask]「{parentName}」終了    {elapsedTime:0.00} 秒" );
		public static OnStartChildCallback   OnStartChild	{ get; set; } = ( parentName, childName ) => Debug.Log( $"[MultiTask]「{parentName}」「{childName}」開始" );
		public static OnFinishChildCallback  OnFinishChild	{ get; set; } = ( parentName, childName, elapsedTime ) => Debug.Log( $"[MultiTask]「{parentName}」「{childName}」終了    {elapsedTime:0.00} 秒" );
		...
		/// コンストラクタ
		/// </summary>
		public MultiTaskWithTimeLog() : this( false )
		{
		}
		...
		/// コンストラクタ
		/// </summary>
		public MultiTaskWithTimeLog( bool isReuse )
		{
